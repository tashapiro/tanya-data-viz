...
connectors<-data.frame(
  ...
  x= c(2001.625,2004.25,2005.5,2006.875, 2006.875,2011,2009.5,2009.5,2012,2012.125,2013.5,2014.75,2015,2017.375,2016.5,2020,2020),
  #x=images$pos[2:length(images$pos)],
  xend = c(2001.625, 2005.5,2005.5,2006.875,2011,2011,2009.5,2012,2012,2013.5,2013.5,2015,2015,2016.5,2016.5,2020,2020),
  #xend = images$pos[2:length(images$pos)],
  y= c(-10,-10,-10,-10,-6,-6,-10,-8,-8,-10,-10,-10,-10,-10,-10,-10,-10),
  yend= c(-4,-10,-4,-6,-6,-4,-8,-8,-4,-10,-4,-10,-4,-10,-4,-10,-4)
)
...
ggplot(data=df, aes(x=year))+
  geom_segment(data = data.frame(y = seq(from=0, to=50, by=5)),
               mapping=aes(x=1999, xend=2023, y=y, yend=y), color="white", size=0.1, alpha=0.2)+
  #leos age data
...
#save plot
ggsave("plot/dicaprio-gfs.png", height=8, width=8,scale=0.58)
